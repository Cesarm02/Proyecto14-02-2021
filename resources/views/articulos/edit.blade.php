...
<div class="container">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Editando {{$comentario->titulo}}</li>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form 
                        action="{{route('publicaciones.update', $comentario)}}" 
                        method="POST"
                    ...
                    >
                        ...
                        <div class="form-group">
                            ...
                            <select name="categoria" class="form-control">
                                <option value="{{old('titulo', $comentario->categoria)}}" selected> {{old('titulo', $comentario->categoria)}}</option> 
                    ...
                    <form action="{{route('publicaciones.destroy', $comentario)}}" method="POST">
